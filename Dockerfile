...
RUN R -q -e 'install.packages(c("BiocManager", "plyr","optparse","devtools","doMC"), repos="https://cran.r-project.org")'
RUN R -q -e 'BiocManager::install(c("HMMcopy", "GenomicRanges", "GenomeInfoDb","BSgenome.Hsapiens.UCSC.hg19","BSgenome.Hsapiens.UCSC.hg38","SNPchip"))'
