...
RUN /bin/sh -c apt-get update && (apt-get install -t buster-backports -y python3-pysam || apt-get install -y python3-pysam) && apt-get clean && apt-get purge && rm -rf /var/lib/apt/lists/* /tmp/*
